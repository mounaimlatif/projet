...
<div class="wrapper">
	<div id="header" class="container">
		...
		<div class="rcol">
			...
			<span class="headsoc">
				<a class="twit thide" href="#">We are in Twitter</a>
				<a class="vkon thide" href="#">We are in vKontakte</a>
			</span>
			<div class="headlinks">
				<ul class="reset">
					<li><a href="/index.php"><i>Home</i></a></li>
					<li><a href="/index.php?do=rules"><i>Rules</i></a></li>
					<li><a href="/index.php?do=feedback"><i>Contact Us</i></a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="wrapper">
		<div class="container">
			<div class="darkbg"><div id="footbox">
				...
				<div class="fbox">
					<div class="dcont">
						<h4 class="btl"><span>Tags Clouds</span></h4>
						{tags}
					</div>
				</div>
				<div class="fbox">
