...
<div class="base shortstory">
		...
		//]]></script>
		<div class="infbtn">
			<span id="infb{search-id}" class="thide" title="Information of news">Information of news</span>
	...
	<div class="bcomment">
		...
		<div class="rcol">
			<div class="combox">
				...
				//]]></script>
				<div class="infbtn">
					<span id="cinfb{search-id}" class="thide" title="Information of comment">Information of comment</span>
