...
<ul class="reset loginbox">
	<li class="lvsep"><a id="loginlink" href="#"><i>Welcome, {login}!</i></a></li>
...
[admin-link]<li><a href="{admin-link}" target="_blank"><b>Admin CP</b></a></li>[/admin-link]
				...
				<li><a href="{pm-link}">Message: ({new-pm} | {all-pm})</a></li>
	...
	<form method="post" action="">
		<div class="logform">
			<ul class="reset">
				...
				<li class="lfield lfpas"><label for="login_password">Password (<a href="{lostpassword-link}">Forgot?</a>):</label><br /><input type="password" name="login_password" id="login_password" /></li>
