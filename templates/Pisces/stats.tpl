<h2 class="dpad heading">Site Statistics</h2>
<div class="baseform"><div class="dcont">
	<div class="lines">
		<ul class="reset">
			<li>Per day: Posted <b>{news_day} Archives</b> and <b>{comm_day} comments</b>, registered <b>{user_day} users </b></li>
			<li>Per week: Posted <b>{news_week} Archives</b> and <b>{comm_week} comments</b>, registered <b>{user_week} users </b></li>
			<li>Per month: Posted <b>{news_month} Archives</b> and <b>{comm_month} comments</b>, registered <b>{user_month} users </b></li>
		</ul>
	</div>
</div></div>
<div class="dpad">
