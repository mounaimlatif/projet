...
<div class="baseform">
	<table class="tableform">
		...
		<tr>
			...
			<td>
				<input style="float: left;" type="text" name="name" id='name' style="width:175px; margin-right: 6px;" class="f_input" /><input class="bbcodes" style="font-size: 11px; float: left;" title="Check Username" onclick="CheckLogin(); return false;" type="button" value="Check Username" />
