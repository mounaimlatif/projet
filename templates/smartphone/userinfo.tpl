...
<div class="panel">
    <div class="news">Full name: {fullname}
                              ...
                              <br /><br />Location: {land}
                              <br />ICQ: {icq}
                              <br />Information:<br />{info}<br /><br />News: {news_num}<br />[ {news} ] [rss]<img src="{THEME}/css/rss_icon.gif" border="0" />[/rss]
                              <br /><br />Comments: {comm_num}<br />[ {comments} ]<br /><br />[ {email} ]<br />[ {pm} ]<br />{edituser}</div>
</div>
