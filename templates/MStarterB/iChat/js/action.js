...
var text_enter_url       = "Entrez l'URL complete du lien";
var text_enter_size       = "Entrez la taille d'une animation flash (largeur, hauteur)";
var text_enter_flash       = "Saisissez un lien vers une video Flash";
var text_enter_page      = "Entrez le numero de page";
var text_enter_url_name  = "Entrez le nom du site";
var text_enter_page_name = "Entrez une description du lien";
var text_enter_image    = "Entrez l'URL complete de l'image";
var text_enter_email    = "Entrez l'adresse e-mail";
var text_code           = "Utilisez: [CODE] Voici votre code.. [/CODE]";
var text_quote          = "Utilisez: [QUOTE] votre code ici.. [/QUOTE]";
var error_no_url        = "Vous devez entrer une URL";
var error_no_title      = "Vous devez entrer un nom";
var error_no_email      = "Vous devez saisir l'adresse e-mail";
var prompt_start        = "Entrez le texte a formater";
var img_title   		= "aligner votre image a (gauche, centre, droite)";
var email_title  	    = "Entrez une description du lien";
var text_pages  	    = "page";
var image_align  	    = "Gauche";
var bb_t_emo  	        = "Inserez smileys";
var bb_t_col  	        = "Couleur du texte:";
var text_enter_list     = "Entrez la liste des elements. Pour completer le laissez le champ vide.";
