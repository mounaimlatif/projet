...
<input class="bbcodes" style="font-size: 11px; float: right;" title="mise en place du chat" onclick="iChatAdmin(); return false;" type="button" value="Parametres" />
<br />&nbsp;
...
<span id="b_emo" onclick="iChat_ins_emo(this);"><img title="emoticones" src="{THEME}/img/bbcode/emo.png" alt="" /></span>
...
<input class="bbcodes" style="font-size: 11px; float: left;" title="Reglement" onclick="iChatRules(); return false;" type="button" value="Reglement" />&nbsp;
<input class="bbcodes" style="font-size: 11px; float: left;" title="Archives" onclick="iChatHistory(); return false;" type="button" value="Archives" />&nbsp;
<input class="bbcodes" style="font-size: 9px; float: right;" title="Envoyer" onclick="iChatAdd('window'); return false;" type="button" value="Envoyer" />
</div>
